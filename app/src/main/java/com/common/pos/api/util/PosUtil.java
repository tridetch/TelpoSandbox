...
public class PosUtil {
    ...
    public synchronized static native int setWGD0(int status);

    public synchronized static native int setWGD1(int status);

    public synchronized static native int getBellStatus();
